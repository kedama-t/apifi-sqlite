...
describe('API Endpoints', () => {
  ...
  describe('GET /:tableName', () => {
    ...
    it('equals (default)', async () => {
      const response = await request(app).get(
        `/${TABLE_NAME}?${COL_ID}=${testData[0].id}`
      );
      expect(response.statusCode).toBe(200);
    ...
    it('equals', async () => {
      const response = await request(app).get(
        `/${TABLE_NAME}?${COL_ID},eq=${testData[0].id}`
      );
      expect(response.statusCode).toBe(200);
      expect(response.body).toEqual([testData[0]]);
    });
    ...
    it('not equals', async () => {
      const response = await request(app).get(
        `/${TABLE_NAME}?${COL_ID},ne=${testData[0].id}`
      );
      expect(response.statusCode).toBe(200);
    ...
    it('notlike', async () => {
      const response = await request(app).get(
        `/${TABLE_NAME}?${COL_NAME},notlike=John`
      );
      expect(response.statusCode).toBe(200);
      expect(response.body).toEqual([testData[1], testData[2]]);
    });
    ...
    it('greater than', async () => {
      const response = await request(app).get(
        `/${TABLE_NAME}?${COL_CREATED_AT},gt=2024-01-01 00:00:00.000`
      );
      expect(response.statusCode).toBe(200);
    ...
    it('greater equal', async () => {
      const response = await request(app).get(
        `/${TABLE_NAME}?${COL_CREATED_AT},ge=2024-01-01 00:00:00.000`
      );
      expect(response.statusCode).toBe(200);
      expect(response.body).toEqual([testData[1], testData[2], testData[3]]);
    });
    ...
    it('lesser than', async () => {
      const response = await request(app).get(
        `/${TABLE_NAME}?${COL_CREATED_AT},lt=2024-01-01 00:00:00.000`
      );
      expect(response.statusCode).toBe(200);
      expect(response.body).toEqual([testData[0]]);
    });
    ...
    it('lesser equal', async () => {
      const response = await request(app).get(
        `/${TABLE_NAME}?${COL_CREATED_AT},le=2024-01-01 00:00:00.000`
      );
      expect(response.statusCode).toBe(200);
  ...
  describe('POST /:tableName', () => {
    ...
    it('check created data', async () => {
      const response = await request(app).get(
        `/${TABLE_NAME}?${COL_ID}=${newRecord.id}`
      );
      expect(response.statusCode).toBe(200);
  ...
  describe('PUT /:tableName', () => {
    it('should update data correctly', async () => {
      const response = await request(app)
        .put(`/${TABLE_NAME}?${COL_ID}=${newRecord.id}`)
        .send(emailForNewRecord);
      expect(response.statusCode).toBe(200);
